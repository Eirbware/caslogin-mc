...
import fr.kumakuma215.casloginfix.command.SetSkinCommand;
import fr.kumakuma215.casloginfix.command.SetSkinCompleter;
...
public final class CasLoginFix extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        INSTANCE = this;
        ConfigurationManager.loadConfig(getDataFolder());
        ...
        if(hasSkinRestorer){
            ...
            this.getCommand("setskin").setTabCompleter(new SetSkinCompleter());
        }
    }
